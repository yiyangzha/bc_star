...
- Spawning subagents without `model: "opus/5.5"` — this silently degrades quality
...
**Iteration limits:** 4/5-bot: warn at 3, strong warn at 5, hard cap at 10. 1-bot: warn at 2, escalate after 3. All subagents use `model: "opus/5.5"`.
